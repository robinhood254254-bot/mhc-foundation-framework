...
export const hearingTests: HearingTest[] = [
  ...
  },
  {
    ...
    summary:
      "An objective test of the hearing nerve and brainstem pathway, recorded from surface electrodes while the patient rests or sleeps. No responses are required.",
    intro:
