...
const heroSlides = [
  {
    ...
    label: "Mombasa Hearing Centre reception",
  ...
  {
    src: media.drMahin.url,
    alt: media.drMahin.alt,
    label: "Dr Mahin Abdilahi Mohamed",
    focal: "top" as const,
  },
  {
...
const trust = [
  ...
  {
    value: "Audiologist-led",
    label: "Every test run by a clinician",
    icon: <Ear className="size-4" />,
  },
  {
    value: "Nkrumah Road",
    label: "NSSF Building, 5th Floor, Mombasa",
    icon: <ShieldCheck className="size-4" />,
  },
  {
    value: "Lifelong aftercare",
    label: "Servicing, batteries and reviews on site",
    ...
    <>
        ...
        <div className="mt-10 grid gap-8 rounded-3xl border border-border bg-surface p-6 shadow-card md:p-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-center">
          <div>
            ...
            <p className="mt-3 text-muted-foreground">
              Most people start with a full diagnostic hearing assessment. It takes under an hour,
              covers otoscopy, pure tone audiometry, speech testing and tympanometry, and tells us
              exactly what to do next. Call the centre and our team will guide you.
            </p>
      ...
      <Section tone="muted" label="Hearing education">
        <SectionHeading
          ...
          actions={
            <CTAButton to="/hearing-education" variant="secondary">
              All resources
            </CTAButton>
          }
        />
      ...
      <Section label="Testimonials">
        <SectionHeading
          ...
          actions={
            <CTAButton to="/testimonials" variant="secondary">
              All testimonials
            </CTAButton>
          }
        />
