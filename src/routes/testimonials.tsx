  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Patient Testimonials | Mombasa Hearing Centre" },
      {
        ...
        content:
          "Verified patient reviews of hearing care and hearing aids at Mombasa Hearing Centre.",
      },
    ...
    <>
          ...
          {[
            {
              ...
              label: "Consistently rated by patients on Google",
            },
            {
              icon: Quote,
              value: `${testimonials.length} written reviews`,
              label: "Published on our Google Business Profile",
            },
            {
              icon: Star,
      ...
      <Section tone="muted" label="What patients say">
        ...
        <p className="mt-8 text-sm text-muted-foreground">
          We are also grateful to {ratingOnlyReviewers.join(", ")} and others who left a star rating
          or shared photos of the centre without a written review.
        </p>
      </Section>
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-14">
          ...
          <div>
            ...
            <p className="mt-4 leading-relaxed text-muted-foreground">
              If we have helped you or a member of your family hear better, a short review helps
              other people in Mombasa and the Coast region find hearing care they can trust. You can
              read all of our reviews, or add your own, on our Google Business Profile.
            </p>
